# -*- coding: utf-8 -*-
"""
Created on Wed Nov 27 16:14:22 2019
...
for train_ix, test_ix in kfold.split(X):
	...
	print('test_acc(%d/%d)=%.3f' % (i+1,n_folds,test_acc))
...
for i in range(1, n_folds+1):
	...
	print('TestScores(%d/%d): single=%.3f, ensemble=%.3f' % (i,n_folds,single_score, ensemble_score))
